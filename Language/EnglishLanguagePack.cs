...
namespace JAXBase.Language
{
    ...
    public class EnglishLanguagePack : IJAXBaseExtension, ILanguagePack
    {
        ...
        // Abreviations for commands, functions, and command parts
        public Dictionary<string, string> Abreviations { get; } = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "endtran", "endtransaction" },
            { "func", "function" },
            { "gath", "gather" },
            { "keyb", "keyboard" },
            { "loc", "locate" },
            { "lparameter", "lparameters" },
            { "lproc", "lprocedure" },
            { "modi", "modify" },
        ...
        public Dictionary<string, string> MathFunctions { get; } = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            {"ACOPY(", "ACOPY("},
            {"ACOS(", "ACOS("},
            {"ADATABASES(", "ADATABASES("},
            {"ADBOBJECTS(", "ADBOBJECTS("},
            {"ADDBS(", "ADDBS("},
            ...
            {"AFONT(", "AFONT("},
            {"AGETCLASS(", "AGETCLASS("},
            {"AGETFILEVERSION(", "AGETFILEVERSION("},
            {"AINS(", "AINS("},
            {"AINSTANCE(", "AINSTANCE("},
            {"ALEN(", "ALEN("},
            {"ALIAS(", "ALIAS("},
            ...
            {"CREATOFFLINE(", "CREATOFFLINE("},
            {"CTOBIN(", "CTOBIN("},
            {"CTOD(", "CTOD("},
            {"CTOT(", "CTOT("},
            {"CURSORGETPROP(", "CURSORGETPROP("},
            {"CURSORSETPROP(", "CURSORSETPROP("},
            {"CURSORTOJSON(", "CURSORTOJSON("},
            {"CURSORTOXML(", "CURSORTOXML("},
            {"CURVAL(", "CURVAL("},
            {"DATE(", "DATE("},
            {"DATETIME(", "DATETIME("},
            {"DAY(", "DAY("},
            ...
            {"GETWORDNUM(", "GETWORDNUM("},
            {"GETCURSORADAPTER(", "GETCURSORADAPTER("},
            {"GOMONTH(", "GOMONTH("},
            {"GUID(", "GUID("},
            {"HEADER(", "HEADER("},
            {"HOME(", "HOME("},
            ...
            {"SQLEXEC(", "SQLEXEC("},
            {"SQLGETPROP(", "SQLGETPROP("},
            {"SQLIDLEDISCONNECT(", "SQLIDLEDISCONNECT("},
            {"SQLMERGERESULTS(", "SQLMERGERESULTS("},
            {"SQLPREPARE(", "SQLPREPARE("},
            {"SQLROLLBACK(", "SQLROLLBACK("},
            {"SQLSETPROP(", "SQLSETPROP("},
            {"SQLSTRINGCONNECT(", "SQLSTRINGCONNECT("},
            {"SQLTABLES(", "SQLTABLES("},
            {"SORT(", "SORT("},
            {"STR(", "STR("},
            {"STRCONV(", "STRCONV("},
        ...
        // Extra keywords found after commands such as ALIAS, TO, FROM, WHERE, along with flags like EXCLUSIVE, SHARED, CANDIDATE, etc.
        ...
        public Dictionary<string, string> PEMs { get; } = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            {"ACTIVEROW","activerow"},
            {"ADDLINEFEEDS","addlinefeeds" },
            {"AERROR","aerror" },
            {"ALIAS","alias"},
            {"ALIGN","align"},
            {"ALIGNMENT","alignment"},
            {"ALLOWADDNEW","allowaddnew"},
            {"ALLOWAUTOCOLUMNFIT","allowautocolumfit" },
            ...
            {"ALLWAYSONBOTTOM","allwaysonbottom" },
            ...
            {"AUTOCLOSETABLES","autoclosetables" },
            ...
            {"CURRENTDATASESSION","currentdatasession" },
            {"CURVATURE","curvature" },
            ...
            {"DISABLEDITEMBACKCOLOR","disableditembackcolor"  },
            {"DISABLEDFORECOLOR","disabledforecolor" },
            {"DISABLEDITEMFORECOLOR","disableditemforecolor" },
            ...
            {"HIGLIGHTFORECOLOR","highlightforecolor" },
            ...
            {"KEYBOARDHIGHVALUE","keyboardhighvalue" },
            {"KEYBOARDLOWVALUE","keyboardlowvalue" },
            ...
            {"SELECTEDITEMFORECOLOR","selecteditemforecolor" },
            {"SELECTDONENTRY","selectedonentry" },
            {"SELLENGTH","sellength" },
            {"SELSTART","selstart" },
            {"SELTEXT","seltext" },
            {"SERVER","server" },
        ...
        // Set commands, which are case-insensitive but have specific casing in the value
        ...
        public Dictionary<string, string> JaxObjects { get; } = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "JAXEDIT","JAXEDIT" },
            { "IPC","IPC" },
            { "IRCCONTENTCLIENT","IRCCONTENTCLIENT" },
            { "LABEL","LABEL" },
            { "LINE","LINE" },
            { "LISTBOX","LISTBOX" },
            { "MENU","MENU" },
