...
{
    public class JAXBase_Executor_R
    {
         ...
         * 
         */
        public static async Task<string> RD(ExecutorCodes eCodes)
        {
         ...
         * 
         */
        public static string Read(ExecutorCodes eCodes)
        {
         ...
         * 
         */
        public static async Task<string> Recall( ExecutorCodes eCodes)
        {
            return await JAXBase_Executor_D.DeleteFor(eCodes, false);
        }
         ...
         * 
         */
        public static async Task<string> Register(ExecutorCodes eCodes)
        {
         ...
         * 
         */
        public static async Task<string> Rename(ExecutorCodes eCodes)
        {
            int err = 0;
         ...
         * 
         */
        public static async Task<string> Replace(ExecutorCodes eCodes)
        {
         ...
         * 
         */
        public static async Task<string> Return(ExecutorCodes eCodes)
        {
            try
            {
