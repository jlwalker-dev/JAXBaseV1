                    ...
                    switch (cmdString.ToLower())
                    {
                        ...
                        default:
                            result = cmdString.ToLower() switch
                            {
                                ...
                                "blank" => JAXBase_Executor_B.Blank(cmdRest),              // Version 0.8
                                ...
                                "gather" => JAXBase_Executor_G.Gather(cmdRest),            // Version 0.8
                                ...
                                "save" => JAXBase_Executor_S.Save(cmdRest),                // Version 1
                                "scan" => await JAXBase_Executor_S.Scan(eCodes),
                                "scatter" => JAXBase_Executor_S.Scatter(cmdRest),          // Version 0.8
