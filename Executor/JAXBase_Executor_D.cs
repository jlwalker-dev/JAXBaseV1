...
namespace JAXBase.Executor
{
    public class JAXBase_Executor_D
    {
         ...
         * 
         */
        public static async Task<string> Delete(ExecutorCodes eCodes)
        {
            try
            {
         ...
         * 
         */
        public static async Task<string> DeleteFor(ExecutorCodes eCodes, bool delete)
        {
            try
            {
                // Delete or recall?
         ...
         *      
         */
        public static async Task<string> Dimension(ExecutorCodes eCodes)
        {
         ...
         */
        public static async Task<string> Do(ExecutorCodes eCodes)
        {
         ...
         */
        public static async Task<string> DoSCX(ExecutorCodes eCodes)
        {
            string result = string.Empty;
            ...
            try
            {
                ...
                {
                    // Look for the file
                    if (await Program.CurrentApp.JaxExecutor.LoadAndExecuteProgram("F", prgToLoad, prgToLoad, null, true))
                    {
                        // TODO - Anything?
                    }
                }
         ...
         */
        public static async Task<string> DoPrg(ExecutorCodes eCodes)
        {
            string result = string.Empty;
            ...
            try
            {
                ...
                // Look for the file
                if (await Program.CurrentApp.JaxExecutor.LoadAndExecuteProgram("P", prgToLoad, prgToRun, null, true))
                {
                    // TODO - Anything?
                }
            }
        ...
        * 
        */
        public static string DoDefault(ExecutorCodes eCodes)
        {
