...
{
    public class JAXBase_Executor_L
    {
        /*
         * 
         * LPARAMETERS
         * 
         */
        public static async Task<string> LParameters(JAXBase_Executor jbe, ExecutorCodes eCodes)
        {
            try
            {
         ...
         * 
         */
        public static async Task<string> Local(ExecutorCodes eCodes)
        {
         ...
         * 
         */
        public static async Task<string> Locate(ExecutorCodes eCodes)
        {
            string result = string.Empty;
         ...
         * 
         */
        public static string Loop( ExecutorCodes eCodes)
        {
            string result = string.Empty;
