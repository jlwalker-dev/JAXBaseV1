...
{
    public class JAXBase_Executor_F
    {
        /* 
         * 
         * FINALLY
         * 
         */
        public static string Finally(ExecutorCodes eCodes)
        {
         ...
         *
         */
        public static async Task<string> For(ExecutorCodes eCodes)
        {
            string result = string.Empty;
         ...
         * 
         */
        public static string ForEach(JAXBase_Executor jbe, ExecutorCodes eCodes)
        {
            string result = string.Empty;
         ...
         * 
         */
        public static string Free(JAXBase_Executor jbe, ExecutorCodes eCodes)
        {
            string result = string.Empty;
