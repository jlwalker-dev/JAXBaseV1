...
{
    public class JAXBase_Executor_P
    {
         ...
         * 
         */
        public static async Task<string> Parameters(JAXBase_Executor jbe, ExecutorCodes eCodes)
        {
            try
            {
         ...
         *
         */
        public static async Task<string> Public(ExecutorCodes eCodes)
        {
            JAXObjects.Token answer = new();
            string result = string.Empty;
