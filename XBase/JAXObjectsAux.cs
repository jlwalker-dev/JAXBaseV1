    ...
    public class JAXObjectsAux
    {
        ...
        public static IJAXAvaClass? GetClass(JAXObjectWrapper jow, string className, string name)
        {
            ...
            try
            {
                ...
                {
                    //"ai" => new XBase_Class_AI(jow, name),
                    ...
                    "cursor" => new XBase_Class_Cursor(jow, name),
                    ...
                    "header" => new XBase_Class_Visual_Header(jow, name),
                    ...
                    //"thread" => new XClass_Thread(jow, name),
