...
namespace JAXBase.XBase
{
    ...
    {
        public new string MyBaseClass { get; } = "OptionButton";
        public new string MyDefaultName { get; } = "option";
        ...
        private async void OptBtn_CheckedChanged(object? sender, EventArgs e)
        {
            ...
            if (Program.CurrentApp.ReturnValue.AsBool() && (me.parent is not null) && (optBtn.IsChecked ?? false))
            {
