...
namespace JAXBase.Executer
{
    ...
    {
        const string thisFile = "JAXBase_Executer_S";
         ...
         * 
         */
        public static async Task<string> Scan(ExecuterCodes eCodes)
        {
            string result = string.Empty;
         ...
         * 
         */
        public static async Task<string> Select(ExecuterCodes eCodes)
        {
            string result = string.Empty;
         ...
         * 
         */
        public static string SelectSQL(ExecuterCodes eCodes)
        {
            string result = string.Empty;
         ...
         * 
         */
        public static async Task<string> Skip(ExecuterCodes eCodes)
        {
         ...
         * 
         */
        public static async Task<string> Store(ExecuterCodes eCodes)
        {
            string result = string.Empty;
